...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  body { font-family:Arial,sans-serif; direction:rtl; color:#1e293b; font-size:13px; padding:30px; }
  h1 { font-size:20px; color:#1a2744; border-bottom:3px solid #0d7c66; padding-bottom:8px; margin-bottom:18px; }
  h2 { font-size:14px; color:#0d7c66; background:#e8f5f2; padding:7px 12px; border-right:4px solid #0d7c66; margin:18px 0 10px; border-radius:4px; }
  h3 { font-size:12px; color:#1a2744; margin:12px 0 6px; font-weight:bold; }
  .grid2 { display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:14px; }
  .field { background:#f8fafc; border:1px solid #e0e6ed; border-radius:6px; padding:8px 12px; }
  .field label { display:block; font-size:10px; color:#6b7280; margin-bottom:2px; }
  .field span { font-weight:bold; }
  .score-row { display:grid; grid-template-columns:repeat(3,1fr); gap:10px; margin:14px 0; }
  .score-card { background:#f8fafc; border:2px solid #e0e6ed; border-radius:8px; padding:12px; text-align:center; }
  .score-card .val { font-size:26px; font-weight:900; }
  .score-card .lbl { font-size:11px; color:#6b7280; margin-top:3px; }
  .ci { padding:3px 0; border-bottom:1px dashed #e0e6ed; font-size:12px; }
  .scale-row { display:flex; justify-content:space-between; padding:4px 0; border-bottom:1px dashed #e0e6ed; font-size:12px; }
  .note-box { background:#f8fafc; border:1px solid #e0e6ed; border-radius:6px; padding:8px 12px; margin:6px 0; min-height:36px; font-size:12px; white-space:pre-wrap; }
  .decision-box { background:#eafaf1; border:2px solid #0d7c66; border-radius:8px; padding:12px 16px; margin:14px 0; font-size:14px; font-weight:bold; color:#0d7c66; }
...
<h3>בחירת התוכנית | הלימה: ${scLabel('fit')}</h3>
${['c6','c7','c8'].map((c,i) => {
